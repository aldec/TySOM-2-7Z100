...
/*This function set the parameters specific for the TySOM-2-7Z100*/
...
void tysom2_set_on_board_hdmi(XIicPs *IicPs)
{
    ...
    wait_for_monitor(IicPs, TYSOM2_HDMI_ADDR);

    // ADV7511 Basic Configuration
    configure_adv7511(IicPs,TYSOM2_HDMI_ADDR);
    // ADV7511 TySOM-2-7Z100 Specific configuration
    configure_adv7511_tysom2(IicPs,TYSOM2_HDMI_ADDR);
}
